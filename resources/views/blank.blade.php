...
<head>
  ...
  <meta name="csrf-token" content="{{ csrf_token() }}">
	...
	<title>NobleUI</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/selectize.js/0.15.2/css/selectize.default.min.css" referrerpolicy="no-referrer"/>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="forms">
              <ul class="nav sub-menu">
                ...
                <li class="nav-item">
                  <a href="{{ route('poster') }}" class="nav-link">Poster Image</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="{{ route('about.page') }}" class="nav-link">fabrics Section</a>
                </li>
                <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="errorPages">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('trashed.categories') }}" class="nav-link">Categories</a>
                </li>
                <li class="nav-item">
    ...
    {{-- <nav class="settings-sidebar">
      <div class="sidebar-body">
        ...
        <div class="theme-wrapper">
          ...
          <a class="theme-item active" href="{{asset('assets')}}/dashboard-one.html">
            <img src="{{asset('assets')}}/images/screenshots/light.jpg" alt="light theme">
          </a>
          <h6 class="text-muted mb-2">Dark Theme:</h6>
          <a class="theme-item" href="{{asset('assets')}}/dashboard-one.html">
		...
		<div class="page-wrapper">
			...
			<nav class="navbar">
                ...
                @else
                <img src="{{ asset('uploads/user') }}/{{Auth::user()->photo}}" alt="profile_image">
                @endif
							</a>
