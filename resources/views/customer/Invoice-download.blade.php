<html>
	...
	<body>
		...
		<header>
			...
			<span><img alt="" src="https://i.postimg.cc/GhRP5ZK1/Logos.png" width="150px"></span>
		</header>
		<article>
			{{-- <h1 style="margin-bottom: 20px">Recipient</h1> --}}
			<address contenteditable>
				<p style="max-width: 200px">{{ $bill_info->bill_company ?? '' }} {{ $bill_info->bill_fname }}</p>
			</address>
			<table class="meta">
				<tr>
					<th><span contenteditable>Invoice #</span></th>
					<td><span contenteditable>{{ $order_info->order_id }}</span></td>
				</tr>
				<tr>
			...
			<table class="inventory">
				...
				<tbody>
                    ...
                    @foreach ($orderProduct  as $index => $product)
                       <tr>
						<td><span contenteditable>{{ $product->rel_to_product->product_name }}</span></td>
			...
			<table class="balance">
                ...
                <tr>
                    ...
                    <td><span data-prefix>$</span><span contenteditable>{{ $sub_total }}</span></td>
                </tr>
			</table>
		</article>
		<aside>
