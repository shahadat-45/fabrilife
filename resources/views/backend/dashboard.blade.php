            ...
            <div class="card-body">
              ...
              @php
                //customer
                  ...
                  $prev_1 = $month2_1 - $month1_1;
                  if ($month1_1 == 0) {
                    $total_1 = 100;
                  }
                  else{
                      $month1_100_1 = $month1_1 / 100;
                      $percent_1 = $month1_1 - $prev_1;
                      $total_1 = $percent_1 / $month1_100_1;
                    }
              @endphp
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5">
                  <h3 class="mb-2">{{ App\Models\Customer::where('created_at', '>=', now()->subDays(30))->count() }}</h3>
        ...
        <div class="col-md-4 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-6 col-md-12 col-xl-5">
                  <h3 class="mb-2">{{ App\Models\Orders::where('created_at', '>=', now()->subDays(30))->count() }}</h3>
                  <div class="d-flex align-items-baseline">
                    @if ($month1_1 > $prev_1)
                      <p class="text-success">
                        <span>+{{ round($total_1) }}%</span>
                        <i data-feather="arrow-up" class="icon-sm mb-1"></i>
                      </p>
                    @else
                      <p class="text-danger">
